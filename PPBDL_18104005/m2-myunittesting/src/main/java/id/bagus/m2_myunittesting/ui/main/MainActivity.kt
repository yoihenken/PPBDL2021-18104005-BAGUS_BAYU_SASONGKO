...
import id.bagus.m2_myunittesting.R
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        when {
            length.isEmpty() -> edtLength.error = getString(R.string.error_empty)
            width.isEmpty() -> edtWidth.error = getString(R.string.error_empty)
            height.isEmpty() -> edtHeight.error = getString(R.string.error_empty)
            else -> {
